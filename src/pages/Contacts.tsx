...
import { GroupManagement } from '@/components/contact/ContactGroupManagement';
    ...
    <div className="flex h-[calc(100vh-120px)]">
      ...
      <div className="flex-1">
        {selectedContact ? (
          ...
          <div className="p-6">
            <GroupManagement contacts={contacts} />
          </div>
        )}
      </div>
    </div>
...
const ContactList = ({ contacts, onSelectContact, onAddContact }: {
  contacts: Contact[];
    ...
    <div className="h-full bg-white">
      ...
      <div className="p-4 border-b">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <CreateContactModal onSave={onAddContact} />
        </div>
      </div>
